...
Encore
     ...
     */
    .addEntry('signup', './assets/ts/signup.ts')
    .addEntry('aos', './assets/js/aos.js')
    ...
    // uncomment to get integrity="CopyPlugin..." attributes on your script & link tags
